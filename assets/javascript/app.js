$(document).ready(function(){
  ...
  firebase.initializeApp(config);
	...
	trainData.on("child_added", function(childSnapshot, prevChildKey){
		...
		$("#train-scheduler-usa> tbody").append("<tr><td>" + firebaseName + "</td><td>" + firebaseLine + "</td><td>"+ firebaseDestination + "</td><td>" + firebaseFrequency + " mins" + "</td><td>" + nextTrainArrival + "</td><td>" + minutes + "</td></tr>");
